...
class EMA():
    '''
        Empirical Moving Average or Exponential Moving Average (EMA) or Exponentially Weighted Moving Average (EWMA), 
        is a type of moving average that gives more weight to recent data points, 
        making it more responsive to new information than a Simple Moving Average (SMA)

        updates ---- θ_ema←β*θ_ema+(1-β)*θ -----so β is emadecay and new θ is self.model
    '''
